...
def sc_get_data(directory: str, name:str, filetype:str):
    if filetype == ".h5":
        ...
        raise ValueError(f"{filetype} is not a valid filetype. Must be h5, h5ad, or mtx.")
...
def get_data(data_dir:str, experiment_dir:str, filename:str, filetype:str, convertR:bool=False):
    if convertR is True:
        ...
        adatas = [sc_get_data(file,samples[n],filetype) for n,file in enumerate(filt_files)]
