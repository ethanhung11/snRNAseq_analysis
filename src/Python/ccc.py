...
def human2mouse(human, map_df=None):
    ...
    # Translate Resource
    mouse = li.rs.translate_resource(human,
                                    map_df=map_df,
...
def liana_mouse_resource(resource_name: Literal['baccin2019', 'cellcall', 'cellchatdb', 'cellinker', 'cellphonedb', 'cellphondbv5', 'celltalkdb', 'connectomedb2020', 'consensus', 'embrace', 'guide2pharma', 'hpmr', 'icellnet', 'italk', 'kirouac2010', 'lrdb', 'mouseconsensus', 'ramilowski2015'] | List[str]):
